    ...
    <div className="App fundo">
      <Container className="borda-tracos">
              ...
              <Row className='d-flex justify-content-center mx-auto'>
                ...
                <Col className='mt-1 col-lg-4 bg-transparent' >
                      <Quadro className="col"
                          imagem={amigavel}
                          porcentagem={'50%'}
                          titulo="Para Pessoas Cansadas de Navegar Sozinhas"
                          texto="Navegue junto com um especialiasta"
                      />
                </Col>
        ...
        <Container>
                ...
                <Col className='mt-1 col-lg-3 bg-transparent' >
                      <Quadro className="col"
                          imagem={contato}
                          porcentagem={'20%'}
